...
public class QUser extends EntityPathBase<User> {
    ...
    public final DateTimePath<java.time.LocalDateTime> deletedAt =
            createDateTime("deletedAt", java.time.LocalDateTime.class);
    ...
    public final ListPath<com.devstagram.domain.post.entity.PostScrap, com.devstagram.domain.post.entity.QPostScrap>
            scraps =
                    this
                            .<com.devstagram.domain.post.entity.PostScrap, com.devstagram.domain.post.entity.QPostScrap>
                                    createList(
                                            "scraps",
                                            com.devstagram.domain.post.entity.PostScrap.class,
                                            com.devstagram.domain.post.entity.QPostScrap.class,
                                            PathInits.DIRECT2);
    ...
    public QUser(Class<? extends User> type, PathMetadata metadata, PathInits inits) {
        ...
        this.userInfo =
                inits.isInitialized("userInfo") ? new QUserInfo(forProperty("userInfo"), inits.get("userInfo")) : null;
    }
}
