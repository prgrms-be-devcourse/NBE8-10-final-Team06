...
public class QDmRoom extends EntityPathBase<DmRoom> {
    ...
    public final ListPath<DmRoomUser, QDmRoomUser> participants = this.<DmRoomUser, QDmRoomUser>createList("participants", DmRoomUser.class, QDmRoomUser.class, PathInits.DIRECT2);
