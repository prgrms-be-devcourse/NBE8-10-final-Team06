...
public class QStory extends EntityPathBase<Story> {
    ...
    public final ListPath<StoryTag, QStoryTag> tags = this.<StoryTag, QStoryTag>createList("tags", StoryTag.class, QStoryTag.class, PathInits.DIRECT2);

    public final StringPath thumbnailUrl = createString("thumbnailUrl");

    public final com.devstagram.domain.user.entity.QUser user;

    public final ListPath<StoryViewed, QStoryViewed> viewers = this.<StoryViewed, QStoryViewed>createList("viewers", StoryViewed.class, QStoryViewed.class, PathInits.DIRECT2);
